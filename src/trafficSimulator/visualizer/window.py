...
class Window:
    ...
    def change_base_play_speed(self, speed):
        if 0 < speed < 101 :
            self.speed = speed
        elif 0>=speed :
            self.speed = 1
    ...
    def draw_signals(self):
        for signal in self.simulation.traffic_signals:
            for segments in signal.segments:
                for segment in segments:
                    if(segment.traffic_signal_state):
                        if(segment.points[1][0]==segment.points[0][0]):
                            dpg.draw_line([segment.points[1][0]-1.5,segment.points[1][1]-1.5],[segment.points[1][0]+1.5,segment.points[1][1]-1.5], color = (0, 255, 0), parent = "Canvas",thickness=0.75*self.zoom)
                        else:
                            dpg.draw_line([segment.points[1][0]-1.5,segment.points[1][1]-1.5],[segment.points[1][0]-1.5,segment.points[1][1]+1.5], color = (0, 255, 0), parent = "Canvas",thickness=0.75*self.zoom)
                    else:
                        if(segment.points[1][0]==segment.points[0][0]):
                            dpg.draw_line([segment.points[1][0]-1.5,segment.points[1][1]-1.5],[segment.points[1][0]+1.5,segment.points[1][1]-1.5], color = (255, 0, 0), parent = "Canvas",thickness=0.75*self.zoom)
                        else:
                            dpg.draw_line([segment.points[1][0]-1.5,segment.points[1][1]-1.5],[segment.points[1][0]-1.5,segment.points[1][1]+1.5], color = (255, 0, 0), parent = "Canvas",thickness=0.75*self.zoom)
